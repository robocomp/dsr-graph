...
/** \mainpage RoboComp::path_planner_astar
 *
 * \section intro_sec Introduction
 *
 * The path_planner_astar component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/path_planner_astar --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class path_planner_astar : public RoboComp::Application
{
public:
	path_planner_astar (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::path_planner_astar::initialize()
{
...
int ::path_planner_astar::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::path_planner_astar app(prefix, startup_check_flag);
