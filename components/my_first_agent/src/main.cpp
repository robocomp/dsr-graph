...
/** \mainpage RoboComp::my_first_agent
 *
 * \section intro_sec Introduction
 *
 * The my_first_agent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/my_first_agent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class my_first_agent : public RoboComp::Application
{
public:
	my_first_agent (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::my_first_agent::initialize()
{
...
int ::my_first_agent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::my_first_agent app(prefix, startup_check_flag);
