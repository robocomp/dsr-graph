...
/** \mainpage RoboComp::missionDSR
 *
 * \section intro_sec Introduction
 *
 * The missionDSR component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/missionDSR --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class missionDSR : public RoboComp::Application
{
public:
	missionDSR (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::missionDSR::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::missionDSR app(prefix, startup_check_flag);
