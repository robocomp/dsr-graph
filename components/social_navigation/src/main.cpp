...
/** \mainpage RoboComp::social_navigation
 *
 * \section intro_sec Introduction
 *
 * The social_navigation component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/social_navigation --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
{
public:
	social_navigation (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::social_navigation::initialize()
{
...
int ::social_navigation::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::social_navigation app(prefix, startup_check_flag);
