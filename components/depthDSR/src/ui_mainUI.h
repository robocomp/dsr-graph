...
public:
    ...
    void setupUi(QMainWindow *guiDlg)
    {
        ...
        splitter_1->setEnabled(true);
        splitter_1->setMinimumSize(QSize(700, 600));
    ...
    {
        guiDlg->setWindowTitle(QApplication::translate("guiDlg", "depthDSR", nullptr));
