...
/** \mainpage RoboComp::testYolo
 *
 * \section intro_sec Introduction
 *
 * The testYolo component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/testYolo --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class testYolo : public RoboComp::Application
{
public:
	testYolo (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::testYolo::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::testYolo app(prefix, startup_check_flag);
