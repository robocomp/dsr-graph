...
class SpecificWorker : public GenericWorker
{
    ...
    private:
        ...
        using LaserData = std::tuple<std::vector<float>, std::vector<float>>;
        ...
        std::tuple<QPolygonF, std::vector<QPointF>> update_laser_polygon(const std::tuple<std::vector<float>, std::vector<float>> &lData);
