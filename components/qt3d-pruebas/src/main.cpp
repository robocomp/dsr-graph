...
/** \mainpage RoboComp::qt3d_pruebas
 *
 * \section intro_sec Introduction
 *
 * The qt3d_pruebas component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/qt3d_pruebas --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class qt3d_pruebas : public RoboComp::Application
{
public:
	qt3d_pruebas (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::qt3d_pruebas::run(int argc, char* argv[])
{
...
int main(int argc, char* argv[])
{
	...
	::qt3d_pruebas app(prefix, startup_check_flag);
