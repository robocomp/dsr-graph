...
/** \mainpage RoboComp::graph_editor
 *
 * \section intro_sec Introduction
 *
 * The graph_editor component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/graph_editor --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class graph_editor : public RoboComp::Application
{
public:
	graph_editor (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::graph_editor::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::graph_editor app(prefix, startup_check_flag);
