...
/** \mainpage RoboComp::human_model
 *
 * \section intro_sec Introduction
 *
 * The human_model component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/human_model --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class human_model : public RoboComp::Application
{
public:
	human_model (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::human_model::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::human_model app(prefix, startup_check_flag);
