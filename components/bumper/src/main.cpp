...
/** \mainpage RoboComp::bumper
 *
 * \section intro_sec Introduction
 *
 * The bumper component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/bumper --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class bumper : public RoboComp::Application
{
public:
	bumper (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::bumper::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::bumper app(prefix, startup_check_flag);
