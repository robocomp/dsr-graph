...
/// \cond INTERNAL
void
RoboCompOmniRobot::OmniRobotPrx::_iceI_getBasePose(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<OmniRobot::GetBasePoseResult>>& outAsync, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
::IceProxy::Ice::Object* ::IceProxy::RoboCompOmniRobot::upCast(OmniRobot* p) { return p; }

void
::IceProxy::RoboCompOmniRobot::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< OmniRobot>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
...
void IceProxy::RoboCompOmniRobot::OmniRobot::_iceI_end_getBasePose(::Ice::Int& iceP_x, ::Ice::Int& iceP_z, ::Ice::Float& iceP_alpha, const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_RoboCompOmniRobot_OmniRobot_getBasePose_name);
    if(!result->_waitForResponse())
    {
...
void IceProxy::RoboCompOmniRobot::OmniRobot::_iceI_end_getBaseState(::RoboCompGenericBase::TBaseState& iceP_state, const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_RoboCompOmniRobot_OmniRobot_getBaseState_name);
    if(!result->_waitForResponse())
    {
...
/// \cond INTERNAL
::Ice::Object* RoboCompOmniRobot::upCast(OmniRobot* p) { return p; }
...
RoboCompOmniRobot::OmniRobot::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
    ...
    ::Ice::StreamWriter< OmniRobot, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}
...
{
    istr->startSlice();
    ::Ice::StreamReader< OmniRobot, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
/// \endcond
...
{
    handle = OmniRobotPtr::dynamicCast(v);
    if(v && !handle)
    {
        IceInternal::Ex::throwUOE(OmniRobot::ice_staticId(), v);
    }
}
/// \endcond
