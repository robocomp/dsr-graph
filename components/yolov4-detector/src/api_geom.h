...
namespace DSR
{
    ...
    public:
        ...
        // Initialize the G,rt_api and inner_eigen values
        //void initialize(std::shared_ptr<DSR::DSRGraph> G, std::shared_ptr<DSR::RT_API> rt_api, std::shared_ptr<DSR::InnerEigenAPI> inner_eigen);
        ...
        // Return distance from translation point of the object (middle point of the boundin box)
