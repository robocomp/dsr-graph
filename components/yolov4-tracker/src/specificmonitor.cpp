...
//	params["InnerModelPath"] = aux;
	...
	configGetString( "","cfg_file", aux.value, "none");
	params["cfg_file"] = aux;
	configGetString( "","weight_file", aux.value, "none");
	params["weight_file"] = aux;
	configGetString( "","names_file", aux.value, "none");
	params["names_file"] = aux;
}
