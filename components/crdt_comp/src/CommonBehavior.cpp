...
/// \cond INTERNAL
void
RoboCompCommonBehavior::CommonBehaviorPrx::_iceI_getParameterList(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<ParameterList>>& outAsync, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
RoboCompCommonBehavior::CommonBehaviorPrx::_iceI_getState(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<State>>& outAsync, const ::Ice::Context& context)
{
