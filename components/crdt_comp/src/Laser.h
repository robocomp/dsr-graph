...
public:
    ...
    {
        return _makeLamdaOutgoing<TLaserData>(response, ex, sent, this, &RoboCompLaser::LaserPrx::_iceI_getLaserData, context);
    }
    ...
    getLaserConfDataAsync(::std::function<void(LaserConfData)> response,
                          ...
                          const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<LaserConfData>(response, ex, sent, this, &RoboCompLaser::LaserPrx::_iceI_getLaserConfData, context);
    }
