...
public:
    ...
    {
        return _makeLamdaOutgoing<int>(response, ex, sent, this, &CommonBehaviorPrx::_iceI_getPeriod, context);
    }
    ...
    setPeriodAsync(int period,
                   ...
                   const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &CommonBehaviorPrx::_iceI_setPeriod, period, context);
    }
    ...
    timeAwakeAsync(::std::function<void(int)> response,
                   ...
                   const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<int>(response, ex, sent, this, &CommonBehaviorPrx::_iceI_timeAwake, context);
    }
    ...
    killYourSelfAsync(::std::function<void()> response,
                      ...
                      const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &CommonBehaviorPrx::_iceI_killYourSelf, context);
    }
    ...
    {
        return _makePromiseOutgoing<ParameterList>(true, this, &CommonBehaviorPrx::_iceI_getParameterList, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto getParameterListAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<ParameterList>>().get_future())
    {
        return _makePromiseOutgoing<ParameterList, P>(false, this, &CommonBehaviorPrx::_iceI_getParameterList, context);
    }

    ::std::function<void()>
    getParameterListAsync(::std::function<void(ParameterList)> response,
                          ::std::function<void(::std::exception_ptr)> ex = nullptr,
                          ::std::function<void(bool)> sent = nullptr,
                          const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<ParameterList>(response, ex, sent, this, &CommonBehaviorPrx::_iceI_getParameterList, context);
    }

    /// \cond INTERNAL
    void _iceI_getParameterList(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<ParameterList>>&, const ::Ice::Context&);
    /// \endcond
    ...
    setParameterListAsync(const ParameterList& l,
                          ...
                          const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &CommonBehaviorPrx::_iceI_setParameterList, l, context);
    }
    ...
    reloadConfigAsync(::std::function<void()> response,
                      ...
                      const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &CommonBehaviorPrx::_iceI_reloadConfig, context);
    }
    ...
    {
        return _makePromiseOutgoing<State>(true, this, &CommonBehaviorPrx::_iceI_getState, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto getStateAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<State>>().get_future())
    {
        return _makePromiseOutgoing<State, P>(false, this, &CommonBehaviorPrx::_iceI_getState, context);
    }

    ::std::function<void()>
    getStateAsync(::std::function<void(State)> response,
                  ::std::function<void(::std::exception_ptr)> ex = nullptr,
                  ::std::function<void(bool)> sent = nullptr,
                  const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<State>(response, ex, sent, this, &CommonBehaviorPrx::_iceI_getState, context);
    }

    /// \cond INTERNAL
    void _iceI_getState(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<State>>&, const ::Ice::Context&);
    /// \endcond
