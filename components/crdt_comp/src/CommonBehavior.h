...
public:
    ...
    getParameterListAsync(::std::function<void(ParameterList)> response,
                          ...
                          const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<ParameterList>(response, ex, sent, this, &RoboCompCommonBehavior::CommonBehaviorPrx::_iceI_getParameterList, context);
    }
    ...
    getStateAsync(::std::function<void(State)> response,
                  ...
                  const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<State>(response, ex, sent, this, &RoboCompCommonBehavior::CommonBehaviorPrx::_iceI_getState, context);
    }
