...
/** \mainpage RoboComp::yolo_tracker
 *
 * \section intro_sec Introduction
 *
 * The yolo_tracker component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/yolo_tracker --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class yolo_tracker : public RoboComp::Application
{
public:
	yolo_tracker (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::yolo_tracker::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::yolo_tracker app(prefix, startup_check_flag);
