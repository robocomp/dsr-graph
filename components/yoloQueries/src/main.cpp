...
/** \mainpage RoboComp::yoloQueries
 *
 * \section intro_sec Introduction
 *
 * The yoloQueries component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/yoloQueries --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class yoloQueries : public RoboComp::Application
{
public:
	yoloQueries (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::yoloQueries::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::yoloQueries app(prefix, startup_check_flag);
