...
public:
    ...
    CRDT_concurrent_operations(RoboCompDSRGetID::DSRGetIDPrxPtr id_prx, std::shared_ptr<DSR::DSRGraph> G_, const std::string& output_, const std::string& output_result_ , int num_ops_, int num_threads_, int agent_id_)
