...
/** \mainpage RoboComp::laserDSR
 *
 * \section intro_sec Introduction
 *
 * The laserDSR component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/laserDSR --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class laserDSR : public RoboComp::Application
{
public:
	laserDSR (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::laserDSR::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	tprx = std::make_tuple(dsrgetid_proxy,laser_proxy);
