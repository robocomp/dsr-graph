...
/** \mainpage RoboComp::inner_api_test
 *
 * \section intro_sec Introduction
 *
 * The inner_api_test component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/inner_api_test --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class inner_api_test : public RoboComp::Application
{
public:
	inner_api_test (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::inner_api_test::initialize()
{
...
int ::inner_api_test::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::inner_api_test app(prefix, startup_check_flag);
