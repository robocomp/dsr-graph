...
/** \mainpage RoboComp::change_graph
 *
 * \section intro_sec Introduction
 *
 * The change_graph component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/change_graph --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class change_graph : public RoboComp::Application
{
public:
	change_graph (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::change_graph::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::change_graph app(prefix, startup_check_flag);
