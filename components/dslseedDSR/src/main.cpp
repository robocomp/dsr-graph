...
/** \mainpage RoboComp::dslseedDSR
 *
 * \section intro_sec Introduction
 *
 * The dslseedDSR component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/dslseedDSR --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class dslseedDSR : public RoboComp::Application
{
public:
	dslseedDSR (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::dslseedDSR::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::dslseedDSR app(prefix, startup_check_flag);
