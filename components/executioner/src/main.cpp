...
/** \mainpage RoboComp::executioner
 *
 * \section intro_sec Introduction
 *
 * The executioner component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/executioner --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class executioner : public RoboComp::Application
{
public:
	executioner (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::executioner::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::executioner app(prefix, startup_check_flag);
