...
/** \mainpage RoboComp::social_rules
 *
 * \section intro_sec Introduction
 *
 * The social_rules component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/social_rules --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class social_rules : public RoboComp::Application
{
public:
	social_rules (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::social_rules::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	RoboCompSocialNavigationGaussian::SocialNavigationGaussianPrxPtr socialnavigationgaussian_proxy;
	...
	try
	{
		...
		socialnavigationgaussian_proxy = Ice::uncheckedCast<RoboCompSocialNavigationGaussian::SocialNavigationGaussianPrx>( communicator()->stringToProxy( proxy ) );
	}
...
int main(int argc, char* argv[])
{
	...
	::social_rules app(prefix, startup_check_flag);
