...
/** \mainpage RoboComp::controller_dsr
 *
 * \section intro_sec Introduction
 *
 * The controller_dsr component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/controller_dsr --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class controller_dsr : public RoboComp::Application
{
public:
	controller_dsr (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::controller_dsr::initialize()
{
...
int ::controller_dsr::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::controller_dsr app(prefix, startup_check_flag);
