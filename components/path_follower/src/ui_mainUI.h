...
public:
    ...
    void setupUi(QMainWindow *guiDlg)
    {
        ...
        menuForces = new QMenu(menubar);
        menuForces->setObjectName(QString::fromUtf8("menuForces"));
        guiDlg->setMenuBar(menubar);
        statusbar = new QStatusBar(guiDlg);
        statusbar->setObjectName(QString::fromUtf8("statusbar"));
        guiDlg->setStatusBar(statusbar);

        menubar->addAction(menuForces->menuAction());
    ...
    void retranslateUi(QMainWindow *guiDlg)
    {
        ...
        menuForces->setTitle(QApplication::translate("guiDlg", "Forces", nullptr));
    } // retranslateUi
