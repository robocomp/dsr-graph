...
/** \mainpage RoboComp::grid_map_dsr
 *
 * \section intro_sec Introduction
 *
 * The grid_map_dsr component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/grid_map_dsr --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class grid_map_dsr : public RoboComp::Application
{
public:
	grid_map_dsr (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::grid_map_dsr::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::grid_map_dsr app(prefix, startup_check_flag);
