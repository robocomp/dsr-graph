...
/** \mainpage RoboComp::locateObject
 *
 * \section intro_sec Introduction
 *
 * The locateObject component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/locateObject --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class locateObject : public RoboComp::Application
{
public:
	locateObject (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::locateObject::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::locateObject app(prefix, startup_check_flag);
