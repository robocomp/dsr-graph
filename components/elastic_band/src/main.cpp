...
/** \mainpage RoboComp::elastic_band
 *
 * \section intro_sec Introduction
 *
 * The elastic_band component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/elastic_band --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class elastic_band : public RoboComp::Application
{
public:
	elastic_band (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::elastic_band::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::elastic_band app(prefix, startup_check_flag);
