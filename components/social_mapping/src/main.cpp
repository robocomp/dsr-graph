...
/** \mainpage RoboComp::social_mapping
 *
 * \section intro_sec Introduction
 *
 * The social_mapping component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/social_mapping --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class social_mapping : public RoboComp::Application
{
public:
	social_mapping (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::social_mapping::initialize()
{
...
int ::social_mapping::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::social_mapping app(prefix, startup_check_flag);
