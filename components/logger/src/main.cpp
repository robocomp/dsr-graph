 ...
 *
 * Just: "${PATH_TO_BINARY}/logger --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class logger : public RoboComp::Application
{
public:
	logger (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::logger::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::logger app(prefix, startup_check_flag);
