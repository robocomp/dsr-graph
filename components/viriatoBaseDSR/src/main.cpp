...
/** \mainpage RoboComp::viriatoBaseDSR
 *
 * \section intro_sec Introduction
 *
 * The viriatoBaseDSR component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/viriatoBaseDSR --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class viriatoBaseDSR : public RoboComp::Application
{
public:
	viriatoBaseDSR (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::viriatoBaseDSR::initialize()
{
