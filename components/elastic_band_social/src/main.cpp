...
/** \mainpage RoboComp::elastic_band_social
 *
 * \section intro_sec Introduction
 *
 * The elastic_band_social component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/elastic_band_social --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class elastic_band_social : public RoboComp::Application
{
public:
	elastic_band_social (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::elastic_band_social::initialize()
{
...
int ::elastic_band_social::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::elastic_band_social app(prefix, startup_check_flag);
