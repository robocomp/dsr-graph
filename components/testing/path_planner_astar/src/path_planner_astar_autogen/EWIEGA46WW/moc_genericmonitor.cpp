...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GenericMonitor_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GenericMonitor_t qt_meta_stringdata_GenericMonitor = {
    {
QT_MOC_LITERAL(0, 0, 14), // "GenericMonitor"
QT_MOC_LITERAL(1, 15, 4), // "kill"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 16) // "initializeWorker"
...
void GenericMonitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->initializeWorker((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
...
QT_INIT_METAOBJECT const QMetaObject GenericMonitor::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_GenericMonitor.data,
