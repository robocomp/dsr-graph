...
#ifndef _GRAPHREQUEST_H_
#define _GRAPHREQUEST_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(GraphRequest_SOURCE)
#define GraphRequest_DllAPI __declspec( dllexport )
#else
#define GraphRequest_DllAPI __declspec( dllimport )
#endif // GraphRequest_SOURCE
#else
#define GraphRequest_DllAPI
#endif
#else
#define GraphRequest_DllAPI
#endif // _WIN32
