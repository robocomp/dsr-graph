...
/*!
 * @file GraphRequestPubSubTypes.h
...
#ifndef _GRAPHREQUEST_PUBSUBTYPES_H_
#define _GRAPHREQUEST_PUBSUBTYPES_H_
...
#error Generated GraphRequest is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif

/*!
 * @brief This class represents the TopicDataType of the type GraphRequest defined by the user in the IDL file.
 * @ingroup GRAPHREQUEST
 */
...
#endif // _GRAPHREQUEST_PUBSUBTYPES_H_