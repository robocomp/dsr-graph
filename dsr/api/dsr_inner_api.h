...
namespace DSR {
    ...
    public:
        ...
        ////////////////////////////////////////////////
        void updateTransformValues(QString transformId, float tx, float ty, float tz, float rx, float ry, float rz,
                                   QString parentId = "");

        void updateTransformValues(QString transformId, QVec v, QString parentId = "");

        void updateTransformValuesS(std::string transformId, float tx, float ty, float tz, float rx, float ry, float rz,
                                    std::string parentId = "");
