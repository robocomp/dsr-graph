...
bool AttribPubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char *>(m_keyBuffer),
                                             Attrib::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
...
bool PairIntPubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    PairInt *p_type = static_cast<PairInt *>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char *>(m_keyBuffer),
                                             PairInt::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer,
                               eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
...
bool DotContextPubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    DotContext *p_type = static_cast<DotContext *>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char *>(m_keyBuffer),
                                             DotContext::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer,
                               eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
...
DotKernelAttrPubSubType::DotKernelAttrPubSubType() {
    ...
    size_t keyLength =
            DotKernelAttr::getKeyMaxCdrSerializedSize() > 16 ? DotKernelAttr::getKeyMaxCdrSerializedSize() : 16;
    m_keyBuffer = reinterpret_cast<unsigned char *>(malloc(keyLength));
    memset(m_keyBuffer, 0, keyLength);
}
...
bool DotKernelAttrPubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    DotKernelAttr *p_type = static_cast<DotKernelAttr *>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char *>(m_keyBuffer),
                                             DotKernelAttr::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer,
                               eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
...
bool MvregEdgeAttrPubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    MvregEdgeAttr *p_type = static_cast<MvregEdgeAttr *>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char *>(m_keyBuffer),
                                             MvregEdgeAttr::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer,
                               eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
...
bool EdgePubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    Edge *p_type = static_cast<Edge *>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char *>(m_keyBuffer),
                                             Edge::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer,
                               eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
...
bool EdgeKeyPubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    EdgeKey *p_type = static_cast<EdgeKey *>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char *>(m_keyBuffer),
                                             EdgeKey::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer,
                               eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
...
bool MvregNodeAttrPubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    MvregNodeAttr *p_type = static_cast<MvregNodeAttr *>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char *>(m_keyBuffer),
                                             MvregNodeAttr::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer,
                               eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
...
DotKernelEdgePubSubType::DotKernelEdgePubSubType() {
    ...
    size_t keyLength =
            DotKernelEdge::getKeyMaxCdrSerializedSize() > 16 ? DotKernelEdge::getKeyMaxCdrSerializedSize() : 16;
    m_keyBuffer = reinterpret_cast<unsigned char *>(malloc(keyLength));
    memset(m_keyBuffer, 0, keyLength);
}
...
bool DotKernelEdgePubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    DotKernelEdge *p_type = static_cast<DotKernelEdge *>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char *>(m_keyBuffer),
                                             DotKernelEdge::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer,
                               eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
...
bool MvregEdgePubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    MvregEdge *p_type = static_cast<MvregEdge *>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char *>(m_keyBuffer),
                                             MvregEdge::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer,
                               eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
...
bool NodePubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    Node *p_type = static_cast<Node *>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char *>(m_keyBuffer),
                                             Node::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer,
                               eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
...
GraphRequestPubSubType::GraphRequestPubSubType() {
    ...
    size_t keyLength =
            GraphRequest::getKeyMaxCdrSerializedSize() > 16 ? GraphRequest::getKeyMaxCdrSerializedSize() : 16;
    m_keyBuffer = reinterpret_cast<unsigned char *>(malloc(keyLength));
    memset(m_keyBuffer, 0, keyLength);
}
...
bool GraphRequestPubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    GraphRequest *p_type = static_cast<GraphRequest *>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char *>(m_keyBuffer),
                                             GraphRequest::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer,
                               eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
...
bool DotKernelPubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    DotKernel *p_type = static_cast<DotKernel *>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char *>(m_keyBuffer),
                                             DotKernel::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer,
                               eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
...
bool MvregPubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    Mvreg *p_type = static_cast<Mvreg *>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char *>(m_keyBuffer),
                                             Mvreg::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer,
                               eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
...
bool OrMapPubSubType::getKey(void *data, InstanceHandle_t *handle, bool force_md5) {
    ...
    OrMap *p_type = static_cast<OrMap *>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char *>(m_keyBuffer),
                                             OrMap::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer,
                               eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
